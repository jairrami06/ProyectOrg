...
palabras db 'BRASIL', 0, 'PERU', 0, 'FRANCIA', 0, 'CHILE', 0, 'ALEMANIA', 0

bufferUsuario db 50 ; Tamaño máximo de la cadena (por ejemplo, 50 caracteres)
               db ?  ; Longitud de la cadena ingresada (se actualizará automáticamente)
               db 50 dup(0) ; Reservar 50 bytes para la cadena
